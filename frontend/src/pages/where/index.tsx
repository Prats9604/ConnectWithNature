    ...
    <>
      ...
      <div className={`relative ${isModalOpen ? "bg-opacity-80" : ""}`}>
        <div className="flex flex-col bg-[#012527] pt-20 pb-10 md:pb-26 px-4 sm:px-8 md:px-10 lg:px-20 gap-4 md:gap-8">
          ...
          <div className="ContributorSegment flex flex-col sm:flex-row gap-4 sm:gap-8 justify-end">
        ...
        {isModalOpen && (
          <>
            ...
            {/* Modal Content */}
            <div className="absolute z-50 top-[90px] right-[40px] bg-white p-4 rounded-lg shadow-md">
              <button
